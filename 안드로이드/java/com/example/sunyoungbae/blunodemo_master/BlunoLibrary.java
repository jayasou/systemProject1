...
public abstract  class BlunoLibrary  extends Activity{
    ...
    BluetoothLeService mBluetoothLeService = BluetoothLeServiceSingleton.getInstance();
    ...
    public void onPauseProcess() {
        ...
        //Toast.makeText(mainContext, "onPause()",Toast.LENGTH_SHORT).show();
    }
    ...
    public void onStopProcess() {
        ...
        resumeProcess();
        //Toast.makeText(mainContext, "onStop()",Toast.LENGTH_SHORT).show();
    }
...
//        Toast.makeText(mainContext, "onDestory()",Toast.LENGTH_SHORT).show();
    }
    ...
    void scanLeDevice(final boolean enable) {
        if (enable) {
            ...
            if(!mScanning)  // false -> true로 전환, 초기화는 false
            {
                mScanning = true;
    ...
    // Device scan callback. 블루투스장치를 스캔하여 넘겨줌. startLeScan()는 LeScanCallback을 파라미터로 가짐
